...
const removeMembers = TryCatch(async (req, res, next) => {
  ...
  if (chat.members.length <= 3) {
    return next(new ErrorHandler("You can't remove more than 3 members", 400));
  }
...
const renameGroup = TryCatch(async (req, res, next) => {
  ...
  if (chat.creator.toString() !== req.user.toString()) {
    return next(new ErrorHandler("You are not allowed to rename members", 403));
  }
...
const deleteChat = TryCatch(async (req, res, next) => {
  ...
  if (chat.groupChat && chat.creator.toString() !== req.user.toString()) {
    return next(
      new ErrorHandler("You are not allowed to delete group chat", 403)
    );
  }
  ...
  // Remove chats, attachments and cloudnary images
